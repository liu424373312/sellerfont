...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getGoodsSta(){
        axios.get(API_PROXY + this.api + '/sell/seller/order/productSalesVolume?token='+this.token+'&startTime='+this.sTime+'&endTime='+this.eTime).then((res) => {
          console.log(res);
      ...
      times(date1) {
        ...
        //console.log(s);
        this.createTimes.push(Y + '-' + M + '-' + D + ' ' + h + ':' + m + ':' + s);
      },
      selectMore() {
