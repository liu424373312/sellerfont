  ...
  export default {
    ...
    methods: {
      ...
      getsDormitory() {
        ...
        axios.get(API_PROXY + this.api + '/sell/seller/group/districtList?token=' + this.token + '&schoolNo=' + this.schoolNo).then((res) => {
          console.log(res);
      ...
      default_dormitory() {
        this.domitory.splice(0,this.domitory.length);
        axios.get(API_PROXY + this.api + '/sell/seller/group/districtList?token=' + this.token + '&schoolNo=1').then((res) => {
          console.log(res);
          this.domitory = res.data.data;
        }).catch((err) => {
          console.log(err);
      ...
      getAll() {
        axios.get(API_PROXY + "http://wxsell.nat200.top/sell/seller/group/list?page=1&size=10&groupDistrict=" + this.groupDistrict + "&token=" + this.token).then(response => {
