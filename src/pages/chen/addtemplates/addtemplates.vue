<template>
    <div class="addtemplates">
        ...
        <div class="weui-tabbar">
            <div class="weui-form-preview__ft" style="background:#0bb20c;width:100%;" @click="showdialog">
                <button class="weui-form-preview__btn weui-form-preview__btn_primary">
                    <span style="color:#fff;">创建模板</span>
                </button>
            </div>
        </div>
        <div class="js_dialog" v-show="dialogshow">
            ...
            <div class="weui-dialog">
                <div class="weui-dialog__hd">
                    <strong class="weui-dialog__title">添加模板</strong>
                </div>
                <div class="weui-dialog__bd">
                    <div class="weui-cell">
                        <input class="weui-input" v-model="templateName" placeholder="请输入模板名称">
                    </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    createRE() {
      ...
      console.log(send);
      axios
        .post(config.sellerUrl + "/sell/seller/template/create", send, {
          headers: {
